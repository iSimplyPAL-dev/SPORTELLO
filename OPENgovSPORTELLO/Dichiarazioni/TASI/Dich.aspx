<%@ Page Title="" Language="C#" MasterPageFile="~/OPENgovSPORTELLO.Master" AutoEventWireup="true" CodeBehind="Dich.aspx.cs" Inherits="OPENgovSPORTELLO.Dichiarazioni.TASI.Dich" %>
<%@ Register Assembly="Ribes.OPENgov.WebControls" Namespace="Ribes.OPENgov.WebControls" TagPrefix="Grd" %>
<asp:Content ID="TitleContent" ContentPlaceHolderID="HeadTitleContent" runat="server">
    <div class="container">
        <div class="navbar-collapse collapse">
            <p id="PageTitle" class="navbar-brand col-md-6"><a class="Tributi text-white">Tributi</a>&ensp;-&ensp;<a class="TASI text-white" id="TitlePage">Consultazione TASI</a>&ensp;-&ensp;Immobile</p>
            <ul class="nav navbar-nav navbar-right-btn">
                <li class="bottoni_header"><asp:Button runat="server" ID="CmdSave" Text="" CssClass="Bottone BottoneSave" OnClientClick="return FieldValidatorTASI();" OnClick="Save"/></li>
        ...
        <div id="divIstanza" class="col-md-12 pageFO">
            ...
            <div id="divDatiUI" class="col-md-12">
                ...
                <div id="divDetUI" class="col-md-12">
                    <div id="divTipoDichiarante" class="col-md-12"></div>
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <p>
                                <label id="lblVia">Ubicazione - Via:</label>
                                <img class="SubmitBtn BottoneMini BottoneMapMarker" onclick="Scopri('SearchStradario');"/>
                                <a href="" target="_blank" class="tooltip HelpFODichTASIUbicazione">
                                    <img class="BottoneMini BottoneHelpMini" />
                                    <span>
                                        <iframe src="" class="HelpFODichTASIUbicazione"></iframe>
                                    </span>
                                </a>
                            </p>
                        ...
                        <div class="col-md-2">
                            <p><label id="lblDataInizio">Data Inizio possesso:</label><label id="lblDataInizioORG" runat="server" class="text-italic"></label></p>
                        ...
                        <div class="col-md-3">
                            <p><label id="lblDataFine">Data Fine possesso:</label></p>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-1">
                            ...
                            <asp:TextBox runat="server" ID="txtFoglio" CssClass="Azzera col-md-10" TabIndex="4"></asp:TextBox>
                        </div>
                        <div class="col-md-1">
                            <p><label id="lblNumero">Numero:</label></p>
                            <asp:TextBox runat="server" ID="txtNumero" CssClass="Azzera col-md-10" TabIndex="5"></asp:TextBox>
                        </div>
                        <div class="col-md-1">
                            <p><label id="lblSub">Subalterno:</label></p>
                            <asp:TextBox runat="server" ID="txtSub" CssClass="Azzera col-md-10" TabIndex="6"></asp:TextBox>
                        </div>
                        <div class="col-md-1">
                            <p><label id="lblCat">Categoria:</label>
                                <a href="" target="_blank" class="tooltip HelpFODichTASICategoria">
                                    <img class="BottoneMini BottoneHelpMini" />
                                    <span>
                                        <iframe src="" class="HelpFODichTASICategoria"></iframe>
                                    </span>
                                </a>
                            </p>
                        ...
                        <div class="col-md-1">
                            <p><label id="lblPercPos">% Possesso:</label></p>
                            <asp:TextBox ID="txtPercPos" runat="server" CssClass="Azzera OnlyNumber text-right col-md-11" TabIndex="8">100</asp:TextBox>
                        </div>
                        <div class="col-md-2">
                            <p><label id="lblRendita">Rendita:</label></p>
                            <asp:TextBox ID="txtRendita" runat="server"  CssClass="Azzera OnlyNumber text-right col-md-8" TabIndex="9"></asp:TextBox>
                        </div>
                        <div class="col-md-5">
                            <p><label id="lblAgevolazioni">Agevolazioni:</label></p>
                            <asp:DropDownList ID="ddlAgevolazioni" runat="server" class="Azzera col-md-11" TabIndex="10"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-md-12 panel panel-primary">
                        <p class="col-md-12">
                            <label>Estremi Contratto Affitto</label>
                            <a href="" target="_blank" class="tooltip HelpFODichTASIEstremiContratto">
                                <img class="BottoneMini BottoneHelpMini" />
                                <span>
                                    <b></b>
                                    <iframe src="" class="HelpFODichTASIEstremiContratto"></iframe>
                                </span>
                            </a>
                        </p>
                        <div class="col-md-5">
                            <p><label id="lblNaturaTitolo">Natura Titolo:</label></p>
                            <asp:DropDownList ID="ddlNaturaTitolo" runat="server" CssClass="Azzera col-md-11" TabIndex="11"></asp:DropDownList>
                        </div>
                        <div class="col-md-4">
                            <p><label id="lblAgEntrateContrattoAffitto">Agenzia Entrate:</label>
                            </p>
                            <asp:TextBox ID="txtAgEntrateContrattoAffitto" runat="server" CssClass="Azzera col-md-11" TabIndex="12"></asp:TextBox>
                        </div>
                        <div class="col-md-3">
                            <label id="lblEstremiContrattoAffitto">Estremi Contratto:</label>
                            <asp:TextBox runat="server" ID="txtEstremiContrattoAffitto" CssClass="Azzera col-md-11" TabIndex="13"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-md-12 hidden">
                        <div class="col-md-5">
                            <p><label id="lblCaratteristica">Caratteristica:</label></p>
                            <asp:DropDownList ID="ddlCaratteristica" runat="server" class="Azzera col-md-11" TabIndex="14"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="col-md-10">
                            <p><label id="lblTipologia">Utilizzo:</label><label id="lblDescrTipologiaORG" runat="server" class="text-italic"></label><asp:HiddenField ID="hfIDTipologiaORG" runat="server" />
                                <a href="" target="_blank" class="tooltip HelpFODichTASIUtilizzo">
                                    <img class="BottoneMini BottoneHelpMini" />
                                    <span>
                                        <iframe src="" class="HelpFODichTASIUtilizzo"></iframe>
                                    </span>
                                </a>
                            </p>
                            <asp:DropDownList ID="ddlTipologia" runat="server" CssClass="Azzera col-md-11" TabIndex="15" AutoPostBack="true" OnSelectedIndexChanged="ddlTipologiaIndexChanged"></asp:DropDownList>
                        </div>
                        <div id="divQuotaCalcolo" class="col-md-2">
                            <p><asp:RadioButton ID="optQuotaRegolamento" runat="server" Text="Quota proprietario da Regolamento" GroupName="TypeQuota" Checked="true"></asp:RadioButton></p>
                            <p><asp:RadioButton ID="optQuotaTotale" runat="server" Text="Quota proprietario Totale" GroupName="TypeQuota"></asp:RadioButton></p>
                        </div>
                    </div>
                </div>
            </div>
            <div id="divMotivazione" class="col-md-12">
                ...
                <div id="divDetMotivi" class="col-md-12">
                    ...
                    <div class="col-md-12">
                        ...
                        <asp:TextBox ID="txtMotivazione" runat="server" TextMode="MultiLine" Width="100%" CssClass="Azzera" TabIndex="16"></asp:TextBox>
                    </div>
                    <div class="col-md-12">
